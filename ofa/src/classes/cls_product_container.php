	...
	class cls_product_container {
		...
		*/
		public function tablaProductos () {
			...
			for ($i = 0; $i<$j; $i++){
				if ( $i%2 == 0)
					echo "<script language='javascript'>updatePrice($i)</script>";
				else
					echo "<script language='javascript'>updateNoPrice($i)</script>";
			}
			*/
			
		}
		
		private function tablaSumatoria($iva=0,$neto=0,$total=0,$cantidad=0,$cantidadMuestras=0){
